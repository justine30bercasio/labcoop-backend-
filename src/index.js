...
app.use(helmet({
  contentSecurityPolicy: {
    directives: {
      defaultSrc: ["'self'"],
      scriptSrc: ["'self'", "'unsafe-inline'", 'code.jquery.com', 'cdn.datatables.net', 'cdn.jsdelivr.net', 'unpkg.com', 'blob:'],
      ...
      connectSrc: ["'self'", 'cdn.jsdelivr.net', 'unpkg.com', 'ws:', 'wss:', 'https://www.google-analytics.com'],
      formAction: ["'self'"],
    },
  },
